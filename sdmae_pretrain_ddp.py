...
if __name__ == '__main__':
    ...
    parser.add_argument('--sdmask_ratio', type=float, default=0.8)
    ...
    for e in range(args.total_epoch):
        ...
        for img, v_img, e_img in tqdm_loader:
            ...
            loss2 = torch.mean((predicted_img - img) ** 2 * mask * e_img) / (torch.sum(mask * e_img)/torch.flatten(e_img).shape[0])
            loss = loss1 + loss2
            loss.backward()
...
# tensorboard --logdir=/home/ljs/PRD-RSMAE/PRD-RSMAE/logs/PRD289K/2024-03-26-15-48-43/SummaryWriter --port=6061
